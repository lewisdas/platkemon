...
public class CutsceneController : MonoBehaviour
{
    ...
    private NPCWalkSystem _npcWalkSystem;
    ...
    private void RunNextCutsceneSegment()
    {
        ...
        switch (segment)
        {
            ...
            case Pause pause:
                ...
                break;
            case NPCWalk npcWalk:
                _currentSystem = _npcWalkSystem;
                _currentSystem.Run(npcWalk);
                break;
        }
    }
